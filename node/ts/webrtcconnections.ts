...
import { CameraInfo, SignallingMessage, WebRTCMessage } from "./util";
import io, { Socket } from 'socket.io-client';
import { safelyParseJSON, generateUUID } from './util'
...
export class WebRTCConnection {
    ...
    constructor(props: WebRTCProps) {
        ...
        this.socket = io('https://localhost', {secure: true});
        ...
        this.socket.on('signalling', (message: SignallingMessage) => {
            ...
            if (sessionDescription?.type === 'offer' || sessionDescription?.type === 'answer') {
                ...
                if (this.isSettingRemoteAnswerPending == true)
                    return;
        ...
        try {
            ...
            this.peerConnection.onnegotiationneeded = async () => {
                ...
                try {
                    ...
                    await this.peerConnection.createOffer().then((offer) => this.peerConnection.setLocalDescription(offer));
